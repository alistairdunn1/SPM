...
//**********************************************************************
void CLogNormalLikelihood::getResult(vector<double>& scores, const vector<double>& expected, const vector<double>& observed, const vector<double>& errorValue,
...
//**********************************************************************
void CLogNormalLikelihood::simulateObserved(const vector<string>& keys, vector<double>& observed, const vector<double>& expected, const vector<double>& errorValue,
                                            const vector<double>& processError, const double delta) {
