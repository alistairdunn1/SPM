...
\usepackage[bookmarks=true,bookmarksopen=false,bookmarksnumbered=true,
            ...
            pdfsubject={Spatial Population Model, Ocean Environmental Technical Report},
            pdftex]{hyperref}
\hypersetup{
...
\newcommand{\VER}{\VERSION-\SourceControlDateDoc} % SPM program version
...
\newcommand{\authors}{\href{mailto:"Alistair Dunn"<Alistair.Dunn@OceanEnvironmental.co.nz>?subject=SPM:}{authors}} %hyper ref for email
\newcommand{\OceanEnv}{\href{www.OceanEnvironmental.co.nz}{Ocean Environmental Ltd.}}
\newcommand{\NIWA}{\href{www.niwa.co.nz}{National Institute of Water \& Atmospheric Research Ltd. (NIWA)}} %NIWA
\newcommand{\ReportNumber}{Ocean Environmental Technical Report}
\newcommand{\OriginalRef}{Dunn, A.; Rasmussen, S.; Mormede, S. (2018). Spatial Population Model User Manual, SPM v1.1-2018-05-31 (rev. 1291) \emph{NIWA Technical Report 138}. NIWA, Wellington, New Zealand, 210 p.} % full document reference
\newcommand{\ManualRef}{Dunn, A.; Rasmussen, S.; Mormede, S. (\DocYear). \SPMName\ User Manual, \SPM\ \VER. \emph{\ReportNumber}. \OceanEnv\ Wellington, New Zealand. \ref{TotPages} p.} % full document reference
...
\begin{titlepage}
  \thispagestyle{empty} % no header/footer/page number on this page
	\begin{center}
		...
		\Large Ocean Environmental Technical Report\\%Document Date
		\Large \DocYear \\%Document Date

		~\vfill
		\SPMName\ User Manual \\ for use with \SPM\ \VER
...
\cleardoublepage{}
  ...
  \pagenumbering{roman}
    ...
    \vspace*{2cm}
		Published by Ocean Environmental \\
		Wellington, New Zealand \\
		\DocYear \\

    \vspace{3cm}
    Enquiries to: \\
    Enquiries@OceanEnvironmental.co.nz\\
