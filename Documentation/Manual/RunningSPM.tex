...
\item [\texttt{-u}] Modify output file names using a unique suffix for each set of free parameter values when doing either a run (\texttt{-r}) or simulating (\texttt{-s}, and parameter values are supplied supplied using \texttt{-i \emph{file}}.
