...
Print a summary of a process. Depending on the process, different summaries are produced. These typically detail the type of process, its parameters and other options, and any associated values. Note that the process report can (optionally) give a summary of the total annual abundance (or biomass) requested, and the total annual abundance (or biomass) removed as a result of this process.
