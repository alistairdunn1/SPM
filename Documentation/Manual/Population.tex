...
To specify an constant annual mortality rate by age \index{Age mortality} for categories `male' and `female' for a model with age classes 1--5, then, 
{\small{\begin{verbatim}
@process NaturalMortality
